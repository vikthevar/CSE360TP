	...
	*/
	...
	protected static void doCreateUser() {
		...
		if (!userNameError.isEmpty()) {
		    ...
		    ViewNewAccount.alertUsernamePasswordError.setHeaderText("Username is not valid.");
		    ViewNewAccount.alertUsernamePasswordError.setContentText(userNameError.trim());
