...
public class ViewAdminHome {
	...
	*/
	...
	protected static Button button_GraderDashboard = new Button("Grader Dashboard");
	...
	*/
	...
	private ViewAdminHome() {
		...
		// setupLabelUI(label_TargetUsername, "Arial", 16, 200, Pos.BASELINE_LEFT, 300,
		// 325);
		// setupTextUI(text_TargetUsername, "Arial", 16, 200, Pos.BASELINE_LEFT, 450,
		// 320, true);
		...
		setupButtonUI(button_GraderDashboard, "Dialog", 16, 250, Pos.CENTER, 300, 420);
		button_GraderDashboard.setOnAction((_) -> {
		    ControllerAdminHome.openGraderDashboard();
		});

		setupButtonUI(button_ManageDiscussion, "Dialog", 16, 250, Pos.CENTER, 300, 470);
		button_ManageDiscussion.setOnAction((_) -> {
			ControllerAdminHome.manageDiscussion();
		});
		...
		theRootPane.getChildren().addAll(label_PageTitle, label_UserDetails, button_UpdateThisUser, line_Separator1,
				...
				button_ListUsers, button_AddRemoveRoles, button_GraderDashboard, button_ManageDiscussion,
				line_Separator4, button_Logout, button_Quit, label_TargetUsername,
