...
public class User {
     ...
     * 
     * @param fn specifies the the firstName for this user
     * 
     * @param mn specifies the the middleName for this user
     * 
     * @param ln specifies the the lastName for this user
     * 
